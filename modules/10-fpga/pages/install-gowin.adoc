...
----
$ cd $FPGA_TOOLS/repos
$ wget https://cdn.gowinsemi.com.cn/Gowin_V1.9.12.03_linux.tar.gz
$ tar -xf Gowin_V1.9.12.03_linux.tar.gz
...
[TIP]
====
Мы скачиваем версию `1.9.12.03`, но со временем она может устареть.
