...
Как мы увидели в xref:06-bus:index.adoc[прошлый раз], писать тестбенчи на SystemVerilog не очень приятно.
...
[, python]
.src/07-cocotb/adder_1_bit/adder_1_bit_tb.py
----
...
[, makefile]
.src/07-cocotb/adder_1_bit/Makefile
----
