...
Icarus Verilog можно установить по xref:down-suite.adoc[инструкции].
Поэтому в данном разделе сосредоточимся на установке Verible и настройке VS Code.

== Установка Verible

NOTE: Считаем, что все условности про переменную `FPGA_TOOLS` из раздела xref:down-suite.adoc[] выполнены.
...
[,console]
----
$ wget https://github.com/chipsalliance/verible/releases/download/v0.0-4071-g8d9f2c97/verible-v0.0-4071-g8d9f2c97-linux-static-x86_64.tar.gz
$ tar -xf verible-v0.0-4071-g8d9f2c97-linux-static-x86_64.tar.gz
$ cp -a verible-v0.0-4071-g8d9f2c97/bin/. $FPGA_TOOLS/bin
----
...
[,console]
----
Verible Verilog Language Server built at v0.0-4071-g8d9f2c97
commandline: verible-verilog-ls --version
Version	v0.0-4071-g8d9f2c97
Commit-Timestamp	2026-06-09T21:02:54Z
Built	2026-06-09T21:03:37Z
----
